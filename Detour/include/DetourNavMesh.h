...
#ifndef MY_RECAST_DETOURNAVMESH_H
#define MY_RECAST_DETOURNAVMESH_H
...
// 感觉可能就是那几种类型吧 solly mesh tile mesh， tem mesh 等
...
// defines high level information related to a dtMeshTile object
// @ingroup detour
struct dtMeshHeader
{
...
// Configuration parameters used to define multi-tile navagation meshes
// the values are used to allocate space during the initialization of a navagation mesh
// @see dtNavMesh::init()
/// @ingroup detour
